...
export default function Home() {
  return (
    <div className="relative flex min-h-0 w-full flex-1 items-center justify-center overflow-auto bg-bg-secondary bg-linear-to-br from-accent-primary/16 via-transparent to-accent-primary/8 px-4 py-8 sm:px-6">
