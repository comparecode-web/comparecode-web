  ...
  return (
    <div className="flex items-center justify-center gap-6 mx-1 bg-bg-primary relative h-[40px] z-20 select-none px-4 border-t border-l border-r border-border-default rounded-t-xl shadow-sm animate-slide-down-fade origin-top">
      <div className="flex items-center gap-2">
        ...
        <button onClick={handlePrev} className="flex items-center justify-center gap-1 rounded px-[var(--btn-px)] h-[var(--btn-height)] text-xs font-semibold text-text-secondary hover:bg-hover-overlay hover:text-text-primary transition-colors outline-none" title="Jump to previous difference">
      ...
      <div className="flex items-center gap-2">
        <button onClick={handleNext} className="flex items-center justify-center gap-1 rounded px-[var(--btn-px)] h-[var(--btn-height)] text-xs font-semibold text-text-secondary hover:bg-hover-overlay hover:text-text-primary transition-colors outline-none" title="Jump to next difference">
          <span>Jump next</span>
          <MdKeyboardArrowDown className="text-lg" />
        </button>
        <button onClick={handleBottom} className="flex items-center justify-center rounded h-[var(--btn-height)] w-[var(--btn-height)] text-text-secondary hover:bg-hover-overlay hover:text-text-primary transition-colors outline-none" title="Jump to bottom">
